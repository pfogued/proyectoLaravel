...
return [
    ...
    | par la classe du validateur. Certaines de ces règles ont plusieurs versions,
    ...
    */
    ...
    'lte' => [
        ...
        'string' => 'Le champ :attribute ne doit pas comporter plus de :value caractères.',
    ],
    ...
    'uploaded' => 'Le :attribute a échoué lors du téléchargement.',
    ...
    | Cela permet de spécifier facilement un message personnalisé pour une règle d'
    | attribut donnée.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes suivantes sont utilisées pour remplacer notre espace réservé
    | d'attribut par quelque chose de plus lisible comme "Adresse e-mail" au lieu de "email".
    | Cela permet de rendre les messages plus expressifs.
    |
    */
