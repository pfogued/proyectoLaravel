...
return [
    ...
    */
    ...
    'lte' => [
        ...
        'file' => 'El campo :attribute no debe ser mayor que :value kilobytes.',
        'numeric' => 'El campo :attribute no debe ser mayor que :value.',
        'string' => 'El campo :attribute no debe ser mayor que :value caracteres.',
    ],
    ...
    | que sea rápido especificar una línea de lenguaje personalizada para una regla
    | de atributo dada.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de lenguaje se usan para reemplazar nuestro marcador de
    | posición de atributo con algo más legible como "Dirección de Correo Electrónico"
    | en lugar de "email". Esto ayuda a hacer los mensajes más expresivos.
    |
    */
